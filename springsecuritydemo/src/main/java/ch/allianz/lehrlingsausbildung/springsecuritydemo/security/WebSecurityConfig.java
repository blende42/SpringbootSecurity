package ch.allianz.lehrlingsausbildung.springsecuritydemo.security;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	@Autowired
	public void applicationSecurityConfiguration(AuthenticationManagerBuilder auth) throws Exception {
